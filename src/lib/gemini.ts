...
【判定フロー（この順序で問いかけて判定）】
1. 今日、自分が行動できることか？ → yes: today
2. 大事だけど今すぐ答えを出さなくていいことか？ → yes: later
3. 今考えても苦しくなるだけで、行動にも結論にもつながらないか？ → yes: release
4. 思い出すと明るくなる、楽しいことか？ → yes: happy
5. ありがたい、満たされることか？ → yes: gratitude

【出力フォーマット】
以下の JSON のみ（コードブロック不要・他テキスト不要）。

{
  "box": "<today|later|release|happy|gratitude>",
